...
class MakerVehiclesController extends Controller {
	...
	public function store(CreateVehicleRequest $request,$makerId)
	{
        ...
        return response()->json(['message'=>'The vehicle was created successfully','code'=>404],404);
	}
	...
	public function show($id,$vehicleId)
	{
        ...
        if (!$vehicle)
        {
            return response()->json(['error message'=>'This vehicle does not exist for this maker','code'=>404],404);
        }
	...
	public function update(CreateVehicleRequest $request, $makerId, $vehicleid)
	{
        ...
        if (!$vehicle)
        {
            return response()->json(['error message'=>'This vehicle does not exist','code'=>404],404);
        }
